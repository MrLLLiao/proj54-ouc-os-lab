...
> current final commit：`db85947 feat(course): add lab runner and grading helpers`（integrated `0001-0009`，rain/root/z2996 三方 full PASS + 新视频 + SHA256 已于 stage14 登记）
> historical stable checkpoint commit：`e8e2fb9 feat(integrated): add lab3 pgcount and lab4 fdcount workflow`（integrated `0001-0007`，三方 full PASS；evidence commit `03aad04`）
