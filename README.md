...
14. 测试报告：`docs/04_test_report.md`
15. AI 使用记录：`docs/05_ai_usage_record.md`
16. 引用与许可证说明：`docs/08_reference_and_license.md`
17. 初赛材料索引：`submissions/draft-report-index.md`
