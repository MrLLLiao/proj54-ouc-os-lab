...

{
  ...
  status_line "docs/15_lab2_process_observation_review.md" "lab2 process observation review" "stage4a clean-baseline apply/make/pstatetest verified"
  status_line "docs/13_technical_report_v0.1.md" "Technical report v0.1" "stage2c draft; not final report"
  status_line "reproducibility/README.md" "Reproducibility package" "lab0/lab1/lab2 reproduction checklist and template"
  ...
  echo "- xv6 baseline make, boot evidence, lab1 patched make, hello output, add2 output, and pstatetest output are summarized in docs/04_test_report.md."
