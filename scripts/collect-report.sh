...

{
  ...
  status_line "docs/18_integrated_helper_review.md" "integrated apply helper safety review" "stage4f red-team: preview safe; --run/--make always require --yes; --make --yes reproduced"
