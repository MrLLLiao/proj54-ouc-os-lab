...

{
  ...
  status_line "docs/final/00_project_overview.md" "final project overview" "stage8a formal portal: OUC xv6 Lab Kit positioning, scoring weights, status, OUC teaching value, reference-project comparison, boundaries"
  ...
  status_line "docs/final/06_testing_and_verification.md" "final testing and verification" "stage8a formal testing coverage table with real-result boundaries"
  ...
  status_line "docs/final/11_known_limits_and_future_work.md" "final limits and future work" "stage8a formal known limits and follow-up plan"
